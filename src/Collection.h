...
public:
	...
	virtual void assign(InputIt first, InputIt last) = 0;
	...
	virtual template<class InputIt>
	...
	virtual void swap(vector& other) noexcept(std::allocator_traits<Allocator>::propagate_on_container_swap::value || std::allocator_traits<Allocator>::is_always_equal::value) = 0;
};
